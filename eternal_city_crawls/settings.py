"""
Django settings for eternal_city_crawls project.
...
SECRET_KEY = 'z2m_=*bg(@ywk!mk)8^&8a8fct+&-d8mazvh$zu&%x*fphg9bd'
...
WSGI_APPLICATION = 'eternal_city_crawls.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'booking@eternalcitycrawls.com'
